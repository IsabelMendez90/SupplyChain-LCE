# v11.2 methodological update

The Streamlit header now displays the application release, decision-model
version, and fuzzy-rule-base version. Both scientific components are identified
as **2.3**, so a mixed deployment can be detected immediately.
